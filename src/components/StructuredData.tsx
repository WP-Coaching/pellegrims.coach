...
export default function StructuredData({ locale }: StructuredDataProps) {
  ...
  const personSchema = {
    ...
    alumniOf: {
      ...
      name:
        locale === "en"
          ? "Master in Sport Sciences, Master in Rehabilitation Sciences"
          : "Master in de Sportwetenschappen, Master in de Revalidatiewetenschappen",
    },
  };
