...
interface LinkProps extends AnchorHTMLAttributes<HTMLAnchorElement> {
  href: string;
  variant?: "default" | "nav" | "footer" | "button" | "unstyled" | "inverted";
  external?: boolean;
}
...
const variants = {
  ...
  footer: "text-sm text-text-muted transition-colors hover:text-text",
  button: "", // Handled by Button component usually, but here for completeness if wrapped
  unstyled: "",
  inverted: "font-medium text-white hover:underline",
};
