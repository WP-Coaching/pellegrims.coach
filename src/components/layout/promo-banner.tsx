    ...
    <section className="relative border-y border-ocean-100 bg-gradient-to-r from-ocean-100 via-ocean-50 to-white py-10">
      <SpotlightBackground
        ...
        spotlights={[
          {
            className:
              "absolute -top-10 -left-10 w-56 h-56 bg-ocean-200 rounded-full blur-3xl opacity-20",
          },
          {
            className:
              "absolute -bottom-12 -right-12 w-64 h-64 bg-ocean-100 rounded-full blur-3xl opacity-30",
          },
        ]}
      />
