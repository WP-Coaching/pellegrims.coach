    ...
    enrollment: {
      ...
      signup: {
        ...
        options: [
          {
            id: "beginners",
            title: txt.payment.beginners,
            time: txt.payment.beginnersTime,
            cta: txt.payment.beginnersCta,
            stripeUrl: beginnersUrl,
          },
          {
            id: "advanced",
  ...
  return (
    <>
      <StructuredData
        ...
        path={`/${locale}/groepen/winter-2025-2026/`}
      />
