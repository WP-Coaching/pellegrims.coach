...
export const en = {
  ...
  meta: {
    ...
    keywords:
      "swimming coach, triathlon coach, swimming training, triathlon training, Belgium, Ward Pellegrims",
  },
  ...
  about: {
    ...
    intro1:
      "Do you want to create your own journey of success and do you want to profit from 12 years of coaching experience in Olympic swimming?",
    intro2:
      "Do you need a structured training plan and/or individual coaching based on the scientific knowledge I gathered during a Master in Sport Sciences and a Master in Rehabilitation Sciences?",
    intro3:
      "Do you want to explore your own limits and fulfill your ambitious physical goals?",
    intro4:
      "The silver medal at the Olympic Games in Rio 2016 was the highlight of my coaching career, but I want to help you reach your own highlights!",
  ...
  generalTerms: {
    meta: {
      title: "General Terms & Conditions | Ward Pellegrims",
      description:
        "Legal terms for Ward Pellegrims detailing the conditions for sports coaching services offered in Belgium.",
    },
    ...
    sections: [
      ...
      {
        id: "identification",
        title: "2. Company Identification",
        paragraphs: [
      ...
      {
        id: "booking",
        title: "4. Bookings and Contract Formation",
        paragraphs: [
      ...
      {
        id: "prices-payments",
        title: "5. Prices, Payments and Invoicing",
        paragraphs: [
      ...
      {
        id: "withdrawal",
        title: "6. Right of Withdrawal and Cancellations",
        paragraphs: [
      ...
      },
      {
        ...
        title: "7. Participant Obligations, Health and Safety",
        paragraphs: [
      ...
      {
        id: "liability",
        title: "8. Nature of Service, Liability and Insurance",
        paragraphs: [
      ...
      {
        id: "image-rights",
        title: "11. Image Rights and Use of Photos and Videos",
        paragraphs: [
    ...
    contact: {
      ...
      addressValue: "Luiaardweg 21, 1850 Grimbergen, Belgium",
      vatLabel: "VAT number",
  ...
  privacyPolicy: {
    meta: {
      ...
      description:
        "Learn how Ward Pellegrims processes personal data collected through the website, contact form, and Stripe payments in accordance with GDPR.",
    },
    title: "Privacy Policy",
    lastUpdated: "Last updated: 7 October 2025",
    intro:
      "We respect your privacy and process personal data in line with the General Data Protection Regulation (GDPR) and Belgian data protection laws. This privacy policy explains which personal data we collect, why we collect it, how we use it and the rights you have.",
    controller: {
    ...
    dataWeCollect: {
      ...
      intro:
        "We only collect data that is necessary for delivering our services and communicating with you.",
      items: [
        {
          title: "Contact form submissions",
          description:
            "When you send us a message we collect your name, email address, subject and the content of your message. If Google reCAPTCHA is enabled to prevent abuse, Google may collect device and usage data as set out in its own privacy notice.",
        },
        {
          title: "Course registrations and payments",
          description:
            "If you book a training session or pay online, Stripe Payments Europe, Limited processes your payment details securely on our behalf. We receive confirmation data such as your name, email address, purchased product, payment status and invoice details. We never store your full payment card information.",
        },
        {
          title: "Technical data",
          description:
            "Our hosting provider (Vercel) automatically stores limited log data when you visit our website, including IP address, browser type and basic device information. This data is used to ensure the security and reliability of the website.",
        },
        {
          title: "Cookies and website analytics",
          description:
            "Our website uses strictly necessary technical cookies to ensure basic functionality. We do not currently use analytics or marketing cookies. Should this change in the future, this privacy policy will be updated and your consent will be requested where required.",
        },
      ],
    },
    howWeUseData: {
    ...
    thirdParties: {
      ...
      intro:
        "We only share personal data with trusted third parties when necessary for the purposes described above.",
      items: [
    ...
    rights: {
      title: "Your Rights",
      intro:
        "You have the following rights under GDPR. You can exercise them at any time by contacting us using the details above.",
      list: [
